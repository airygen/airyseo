...
class Launcher {
	...
	/**
	 * Plugin name, e.g. airyseo/airyseo.php
	 *
	 * @var string
	 */
	public $plugin_name = '';
	...
	/**
	 * Plugin base, e.g. /var/www/html/wp-content/plugins/airyseo/airyseo.php
	 *
	 * @var string
	 */
	public $plugin_base = '';
	...
	private function load_front_modules(): void {
		...
		if ( 'yes' === airyseo_get_option( Constants::OPTION_ENABLE_FACEBOOK_OG_TAGS ) ) {
			new Modules\FacebookOpenGraph();
		}

		if ( 'yes' === airyseo_get_option( Constants::OPTION_ENABLE_TWITTER_CARD ) ) {
